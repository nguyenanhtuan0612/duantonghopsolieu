...
class TestController {
    ...
    async testMomoApi(req,res){
        try{
            ...
            var redirectUrl = "https://mcbooks.vn/"; //chi viet
            ...
            orderId+"&orderInfo="+orderInfo+"&partnerCode="+Momo.partnerCode+"&redirectUrl="+redirectUrl+"&requestId="+requestId+"&requestType=captureWallet"
            console.log(rawSignature)
            const signature = crypto.createHmac('sha256', Momo.secretKey).update(rawSignature.toString()).digest('hex');
